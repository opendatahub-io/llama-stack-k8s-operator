...
func ApplyService(ctx context.Context, cli client.Client, scheme *runtime.Scheme, instance *llamav1alpha1.LlamaStackDistribution, service *corev1.Service, logger logr.Logger) error {
